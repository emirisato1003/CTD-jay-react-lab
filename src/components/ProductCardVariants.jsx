export default function ProductCardVariants({ variants, closeVariants, handleAddItemToCart }) {
                    ...
                    return (
                        <li key={variant.id} className="productVariant">
                            <div className="variantPreview">
                                {/* <img src={`/public/product-images/${variant.image}`} alt={variant.variantDescription} /> */}
                                <p>${variant.price}</p>
                            </div>
